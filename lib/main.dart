    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              //TextEditingControllera ihtiyaç duymaz.Çünkü onSaved vardır.
              TextFormField(
                onSaved: (gelenUserName) {
                  _userName = gelenUserName!;
                },
                //varsayılan değeri tanımlar
                //initialValue: "mehmetkardaş",
...
class _TextFieldWidgetKullanimiState extends State<TextFieldWidgetKullanimi> {
  ...
  void initState() {
    ...
    _emailController = TextEditingController(
      //text: "kralosimhen@galatasaray.com",
    );
  ...
  //dispose bir sayfa kapandıgında o sayfayı durdurur kapanır giriş yapınca şifremiz gibi
  @override
  void dispose() {
